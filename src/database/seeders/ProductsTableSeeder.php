...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'price' => '800',
            'image' => 'kiwi.png',
            'description' => 'キウイは甘みと酸味のバランスが絶妙なフルーツです。ビタミンCなどの栄養素も豊富なため、美肌効果や疲労回復効果っも期待できます。もぎたてフルーツのスムージーをお召し上がりください！'
        ];
        ...
        $param = [
            ...
            'description' => '子供から大人まで大人気のストロベリー。当店では鮮度抜群の完熟いちごを使用しています。ビタミンCはもちろん食物繊維も豊富なため、腸内環境の改善も期待できます。もぎたてフルーツのスムージーをお召し上がりください！'
        ];
        DB::table('products')->insert($param);
        $param = [
            'name' => 'オレンジ',
